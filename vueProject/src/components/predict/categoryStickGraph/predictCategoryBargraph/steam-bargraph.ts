...
export default defineComponent({
  ...
  setup(props) {
    ...
    var server_category_data = computed(()=>store.state.getTotalLastCategoryDataList[8])
    var server_category_predict_data = computed(()=>store.state.getPredictCategory['열'])
