...
export default defineComponent({
  ...
  setup(props) {
    ...
    var server_category_data = computed(()=>store.state.getTotalLastCategoryDataList[4])
    var server_category_predict_data = computed(()=>store.state.getPredictCategory['비료사용'])
