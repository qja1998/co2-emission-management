...
export default defineComponent({
  ...
  setup(props) {
    ...
    var server_category_data = computed(()=>store.state.getTotalLastCategoryDataList[3])
    var server_category_predict_data = computed(()=>store.state.getPredictCategory['폐기물처리시설'])
