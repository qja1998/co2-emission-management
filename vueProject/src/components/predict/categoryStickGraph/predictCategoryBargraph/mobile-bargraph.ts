...
export default defineComponent({
  ...
  setup(props) {
    ...
    var server_category_data = computed(()=>store.state.getTotalLastCategoryDataList[1])
    var server_category_predict_data = computed(()=>store.state.getPredictCategory['이동연소'])
