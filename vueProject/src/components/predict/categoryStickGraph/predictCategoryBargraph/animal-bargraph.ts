...
export default defineComponent({
  ...
  setup(props) {
    ...
    var server_category_data = computed(()=>store.state.getTotalLastCategoryDataList[5])
    var server_category_predict_data = computed(()=>store.state.getPredictCategory['대학소유동물'])
