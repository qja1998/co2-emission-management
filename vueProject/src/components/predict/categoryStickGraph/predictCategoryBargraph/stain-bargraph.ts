...
export default defineComponent({
  ...
  setup(props) {
    ...
    var server_category_data = computed(()=>store.state.getTotalLastCategoryDataList[0])
    var server_category_predict_data = computed(()=>store.state.getPredictCategory['고정연소'])
