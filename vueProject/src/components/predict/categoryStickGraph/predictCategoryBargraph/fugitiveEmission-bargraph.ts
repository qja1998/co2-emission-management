...
export default defineComponent({
  ...
  setup(props) {
     ...
     var server_category_data = computed(()=>store.state.getTotalLastCategoryDataList[2])
     var server_category_predict_data = computed(()=>store.state.getPredictCategory['탈루배출'])
